...
export interface Certification {
  ...
  code: string;
  issuer: "AWS" | "Google Cloud" | "Anthropic" | "CNCF" | "HashiCorp";
...
export const CERTIFICATIONS: Certification[] = [
  ...
  },
  {
    ...
    code: "GAIL",
    issuer: "Google Cloud",
    credlyUrl: "https://www.credly.com/badges/b0e5d2af-e68a-4967-8f0a-ac4c53a38638/public_url",
  ...
  // ── Anthropic ────────────────────────────────────────────
  {
    ...
    code: "CCA-F",
    issuer: "Anthropic",
    credlyUrl: "https://www.credly.com/badges/4691832d-21d5-469c-b490-0e4a8ff6b066/public_url",
 ...
 * When one is earned: move it to CERTIFICATIONS with its credlyUrl + badgeUrl.
 */
