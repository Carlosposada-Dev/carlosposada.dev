...
export interface Certification {
  ...
  code: string;
  issuer: "AWS" | "Google Cloud" | "Anthropic" | "Microsoft" | "CNCF" | "HashiCorp";
  /** Public URL where the credential can be verified */
  credentialUrl: string;
  /** Official badge image URL (issuer CDN) */
  badgeUrl: string;
  /**
   * Dónde se verifica. Por defecto Credly, que es donde viven AWS, Google Cloud
   * y Anthropic. Microsoft retiró sus certificaciones de Credly y ahora las
   * publica en Microsoft Learn, así que el emisor y el verificador ya no
   * coinciden siempre.
   */
  verifier?: string;
  /** Issuer brand color */
...
/** Verificador por defecto cuando `Certification.verifier` no está */
export const DEFAULT_VERIFIER = "Credly";
...
// Anthropic SVG path (SimpleIcons)
const ANTHROPIC_SVG =
  "M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6082 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.5409Zm-.3712 10.2232 2.2914-5.9456 2.2914 5.9456Z";
// Microsoft SVG path (SimpleIcons) — los cuatro cuadrados del logo
const MICROSOFT_SVG =
...
export const CERTIFICATIONS: Certification[] = [
  // ── AWS ──────────────────────────────────────────────────
  {
    ...
    code: "SAA-C03",
    issuer: "AWS",
    credentialUrl: "https://www.credly.com/badges/b9a1d29b-f8ce-421c-915b-6c3d3d49a2e2/public_url",
  ...
  },
  {
    ...
    code: "DVA-C02",
    issuer: "AWS",
    credentialUrl: "https://www.credly.com/badges/b2af596a-0a58-4782-9b51-65973bc34af0/public_url",
  ...
  },
  {
    ...
    code: "SOA-C03",
    issuer: "AWS",
    credentialUrl: "https://www.credly.com/badges/de0a31a7-ea42-4ae5-8ce9-3bc790ea8b6d/public_url",
  ...
  },
  {
    ...
    code: "AIF-C01",
    issuer: "AWS",
    credentialUrl: "https://www.credly.com/badges/e9bd2911-dcf7-4345-a9af-74e83e15e3c2/public_url",
  ...
  },
  {
    ...
    code: "CLF-C02",
    issuer: "AWS",
    credentialUrl: "https://www.credly.com/badges/12973993-e377-4a4b-9214-263343aeff19/public_url",
  ...
  // ── Google Cloud ─────────────────────────────────────────
  {
    ...
    code: "ACE",
    issuer: "Google Cloud",
    credentialUrl: "https://www.credly.com/badges/4e241773-5bb7-4bea-8814-cc3e2460fa70/public_url",
  ...
  },
  {
    ...
    code: "PCA",
    issuer: "Google Cloud",
    credentialUrl: "https://www.credly.com/badges/0e4532bd-562e-43dd-9746-36561343ca7d/public_url",
  ...
  },
  {
    ...
    code: "GAIL",
    issuer: "Google Cloud",
    credentialUrl: "https://www.credly.com/badges/b0e5d2af-e68a-4967-8f0a-ac4c53a38638/public_url",
    badgeUrl: "https://images.credly.com/size/680x680/images/ec23e41a-0f32-4a98-9c00-28925621b281/blob",
    accentColor: "#4285F4",
    svgPath: GCP_SVG,
  },
  // ── Microsoft ────────────────────────────────────────────
  // Microsoft ya no publica en Credly: la credencial vive en Microsoft Learn y
  // el badge es el escudo genérico "Certified Associate" que sirve Microsoft.
  {
    id: "ms-az104",
    ...
    issuer: "Microsoft",
    credentialUrl:
      "https://learn.microsoft.com/api/credentials/share/en-us/carlosposada-9659/6F854B2E7A116E4E?sharingId=DDA99E9CB09FC63E",
    badgeUrl:
    ...
    accentColor: "#00A4EF",
    svgPath: MICROSOFT_SVG,
  },
  // ── Anthropic ────────────────────────────────────────────
  {
    id: "anthropic-cca-foundations",
    title: "Claude Certified Architect — Foundations",
    code: "CCA-F",
    issuer: "Anthropic",
    credentialUrl: "https://www.credly.com/badges/4691832d-21d5-469c-b490-0e4a8ff6b066/public_url",
    badgeUrl: "https://images.credly.com/size/680x680/images/f2040db3-3904-4240-8966-e87b1510bea0/blob",
    accentColor: "#D97757",
    svgPath: ANTHROPIC_SVG,
  },
];

/**
 * Certifications on the roadmap — NOT earned yet.
 * Rendered as dashed "ghost" cards inside their issuer group so a track in
 * progress reads as trajectory instead of an empty panel.
 * When one is earned: move it to CERTIFICATIONS with its credentialUrl + badgeUrl.
 */
...
export const PLANNED_CERTIFICATIONS: PlannedCertification[] = [
  // Anthropic — Claude Certified track (4 exams, Foundations already earned)
  {
    id: "anthropic-cc-associate",
